...
namespace Lockstep.FakeServer
{
    public class KcpRoom
    {
        ...
        public void Init(int type)
        {
            ...
            _kcpProxys = new KCPProxy[MaxPlayerCount];
        }
